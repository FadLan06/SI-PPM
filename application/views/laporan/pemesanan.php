        ...
        <div class="form-row align-items-center">
          ...
          <div class="col-auto">
            ...
            <?php if(isset($_POST['cari'])): ?>
              <a href="<?=base_url('Laporan/Pemesanan')?>" class="btn btn-danger btn-sm"><i class="fas fa-sync-alt"></i> Refresh</a>
            <?php endif; ?>
          </div>
        </div>
      </form>
  ...
  <?php if(isset($_POST['cari'])): ?>
    <div class="card shadow mb-4">
      ...
      <div class="card-header">
        <form action="<?=base_url('Laporan/Pemesanan_')?>" method="post"  target="_blank">
        ...
        <form action="<?=base_url('Laporan/Export_Pemesanan')?>" method="post">
            <input type="hidden" name="filter" id="filter" class="form-control" value="<?=$_POST['filter']?>">
            <input type="hidden" name="bulan" id="bulan" class="form-control" value="<?=$_POST['bulan']?>">
            <input type="hidden" name="tahun" id="tahun" class="form-control" value="<?=$_POST['tahun']?>">
